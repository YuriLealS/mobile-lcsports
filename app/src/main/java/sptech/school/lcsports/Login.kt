...
//            Toast.makeText(baseContext, "Feed", Toast.LENGTH_SHORT).show()
...
//        }
        ...
        binding.btLogar.setOnClickListener {
            if (binding.etEmail.text.toString().isEmpty()) {
                ...
                val url = "https:///v1/usuarios/autenticar"
                        ...
                        runOnUiThread {
                            if (responseStatus == 404) {
                                ...
                                if (responseBody != null) {
                                    ...
                                    val intent = Intent(this@Login, MeuPerfil::class.java)
                                    intent.putExtra("DadosUsuario", login)
                                    startActivity(intent)
                                }
                            } else {
                                Toast.makeText(
